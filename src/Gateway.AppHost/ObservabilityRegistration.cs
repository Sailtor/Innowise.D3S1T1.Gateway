...
internal static class ObservabilityRegistration
{
    ...
    {
        // Compact JSON rather than plain text: these logs are read by a collector in compose, and
        // structured output is the whole reason for choosing Serilog over the default logger.
